...
data object BinanceSmartChainBlockchainProvider : BlockchainProvider<BinanceSmartChainBlockchain>() {
    override fun get(isTestnet: Boolean): BinanceSmartChainBlockchain = if (isTestnet) BinanceTestnetSmartChainBlockchain else BinanceMainnetSmartChainBlockchain
